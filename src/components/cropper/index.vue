    ...
    <div v-if="dataUrl" class="avatar-cropper-overlay">
      ...
      <div class="avatar-cropper-container">
        <div class="avatar-cropper-image-container">
          <img ref="img" :src="dataUrl" alt="User Avatar" @load.stop="createCropper"/>
        </div>
        <div class="avatar-cropper-footer">
          <button class="avatar-cropper-btn btn-danger"
                  type="button"
                  @click="destroy"
          ...
          <button class="avatar-cropper-btn btn-success"
                  @click="submit"
...
<script>
  ...
  export default {
    ...
    props: {
      ...
      mimes: {
        type: String,
        default: 'image/png, image/gif, image/jpeg, image/bmp, image/x-icon, image/jpg'
      },
      labels: {
        type: Object,
        default () {
