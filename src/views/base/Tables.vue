<template>
  <div class="animated fadeIn">
    ...
    <b-row>
      <b-col lg="6">
        <c-table :table-data="items" :fields="fields"
    ...
    <b-row>
      ...
      <b-col lg="6">
        <c-table :table-data="items" fixed bordered
                 caption="<i class='fa fa-align-justify'></i> Bordered Table"></c-table>
      </b-col>
    </b-row>

    <b-row>
      <b-col sm="12">
        <c-table :table-data="itemsArray" :per-page=10 hover striped bordered small fixed
                 caption="<i class='fa fa-align-justify'></i> Combined All Table"></c-table>
      </b-col>
    </b-row>
    <b-row>
      <b-col sm="12">
        <c-table dark :table-data="itemsArray" :per-page=10 hover striped bordered small fixed
                 caption="<i class='fa fa-align-justify'></i> Dark Table"></c-table>
      </b-col>
    </b-row>
  </div>
